...
class Consumer extends EnhancedEventEmitter_1.default {
     ...
     * @emits @producerclose
     */
    constructor({ internal, data, channel, appData, paused, producerPaused, score = { score: 10, producerScore: 10 } }) {
        super(logger);
        // Closed flag.
        this._closed = false;
        // Paused flag.
    ...
    setPreferredLayers({ spatialLayer, temporalLayer }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._channel.request('consumer.setPreferredLayers', this._internal, reqData);
        });
    }
    /**
    ...
    enablePacketEvent(types = []) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('pause()');
            const reqData = { types };
            yield this._channel.request('consumer.enablePacketEvent', this._internal, reqData);
        });
    }
