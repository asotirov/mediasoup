...
const PlainRtpTransport_1 = require("./PlainRtpTransport");
...
class Router extends EnhancedEventEmitter_1.default {
    ...
    createWebRtcTransport({ listenIps, enableUdp = true, enableTcp = false, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, appData = {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const internal = Object.assign(Object.assign({}, this._internal), { transportId: uuidv4() });
            const reqData = {
                listenIps,
                enableUdp,
                enableTcp,
     ...
     */
    createAudioLevelObserver({ maxEntries = 1, threshold = -80, interval = 1000 } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('createAudioLevelObserver()');
            const internal = Object.assign(Object.assign({}, this._internal), { rtpObserverId: uuidv4() });
